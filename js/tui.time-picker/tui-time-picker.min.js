...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SELECTOR_SECOND_ELELEMENT = '.tui-timepicker-second';
	 ...
	 * @param {number} [options.initialSecond = 0] - Initial setting value of second
	...
	var TimePicker = snippet.defineClass(/** @lends TimePicker.prototype */ {
	    init: function(container, options) {
	         ...
	         * @private
	         */
					this._second = options.initialSecond || 0;
	    ...
	    _setEvents: function() {
	        this._hourInput.on('change', this._onChangeTimeInput, this);
					...
					this._secondInput.on('change', this._onChangeTimeInput, this);
	    ...
	    _renderTimeInputs: function() {
	        ...
	        var $hourElement = this._$element.find(SELECTOR_HOUR_ELELEMENT);
					...
					var $secondElement = this._$element.find(SELECTOR_SECOND_ELELEMENT);
	        ...
	        this._minuteInput = new BoxComponent($minuteElement, {
	            ...
	            items: timeUtil.getRangeArr(0, 59)
					...
					this._secondInput = new BoxComponent($secondElement, {
	            initialValue: this._second,
	            items: timeUtil.getRangeArr(0, 59)
	        });
	    },
	    ...
	    _syncToInputs: function() {
	        ...
	        this._hourInput.setValue(hour);
					...
					this._secondInput.setValue(second);
	    },
	    ...
	    _onChangeMeridiem: function(event) {
	        ...
	        this.setTime(hour, this._minute, this._second);
	    },
	    ...
	    _onChangeTimeInput: function() {
	        var hour = this._hourInput.getValue();
					...
					var second = this._secondInput.getValue();
	        var isPM = this._hour >= 12;
	    ...
	    setHour: function(hour) {
	        return this.setTime(hour, this._minute, this._second);
	    },
	    ...
	    setMinute: function(minute) {
	        return this.setTime(this._hour, minute, this._second);
			},

			/**
	     * Set minute
	     * @param {number} second for time picker
	     * @returns {boolean} result of set time
	     */
	    setSecond: function(second) {
	        return this.setTime(this._hour, this._minute, second);
	    },
	    ...
	    setTime: function(hour, minute, second) {
	        var isNumber = snippet.isNumber(hour) && snippet.isNumber(minute) && snippet.isNumber(second);
	        if (!isNumber || (hour > 23) || (minute > 59) || (second > 59)) {
	            return;
	        }
